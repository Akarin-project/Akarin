...
public class ParticleTest extends AbstractTestingBase {
    ...
    public void verifyMapping() {
        ...
        for (net.minecraft.server.Particle nms : (Iterable<net.minecraft.server.Particle<? extends net.minecraft.server.ParticleParam>>) IRegistry.PARTICLE_TYPE) { // Eclipse fail // Akarin - fixes eclipse
