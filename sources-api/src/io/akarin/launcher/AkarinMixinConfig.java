...
public class AkarinMixinConfig {
    
    public final static Logger logger = LogManager.getLogger("Akarin Launcher");
    ...
    public static void init(File configFile) {
        ...
        readConfig(AkarinMixinConfig.class, null);
    }
